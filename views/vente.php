...
if (isset($_GET['order'])) {
  $del_com = $connexion->prepare("DELETE FROM commande where (id) not in (SELECT commande from panier)");
  $del_com->execute();
}
?>
...
<head>
  ...
  <style>
    ...
    @media print {
      /* Masquer les éléments de navigation et contrôles */
      .no-print,
      .mobile-nav-toggle,
      .header-section,
      .filter-section,
      ...
      /* Masquer la colonne Actions du tableau */
      .table th:last-child,
      .table td:last-child {
        display: none !important;
      }

      /* Ajuster le style du tableau pour l'impression */
      .table {
        width: 100% !important;
        margin: 0 !important;
      ...
      /* Masquer les éléments de footer et autres */
      footer,
      .back-to-top {
        display: none !important;
      }
                    ...
                    <div class="col-xl-6 col-lg-8 col-md-10">
                      <div class="card card-custom border-danger">
                        ...
                        <div class="card-body">
                          ...
                          <div class="">
                            <strong><?= $client_nom ?></strong> de <?= $supprimer['quantite'] ?> L <?= $supprimer['type'] ?>au prix de : <?= $supprimer['prixunitaire'] ?> $/L
                          </div>
                            ...
                            <table class="table table-sm table-hover">
                              ...
                              <tbody>
                                ...
                                ?>
                                  <tr>
                                    <td><?= $data['quantite'] ?></td>
                                    <td><?= ucfirst($designation) . " " . $data['type'] ?></td>
                      ...
                      <div class="card card-custom">
                        ...
                        <div class="card-body">
                          <div class="print-header" style="display: none;">
                            <div style="text-align: center; font-family: 'Courier New', monospace; font-size: 12px; font-weight: bold; margin-bottom: 20px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                              STATION MUYISA ENERGIE<br>
                              RCCM: CD/Bbo/RCCM/23-A-1446 | IMPÔT: A 20271017P | ID.NAT: 19-G4701-N50027E<br>
                              Adresse: Q.VUTESTE, Cell. LUSANDO, N° 1<br>
                              Tél: +243 993580599, +243 997287934<br><br>
                              LISTE DES VENTES - <?php echo date('d/m/Y'); ?><br>
                              ======================================================================================================
                            </div>
                          </div>
                          <div class="table-responsive">
                              ...
                              <tbody>
                                ...
                                <?php if ($numero > 0): ?>
                                  <tr class="table-success fw-bold">
                                    ...
                                    <td><strong><?= number_format($totalg, 2) ?> $</strong></td>
                                    <td></td>
