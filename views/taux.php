...
include_once('../models/select/sel-taux.php');
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="row">
                        ...
                        <div class="col-12 h-100  d-flex justify-content-center align-items-center p-4">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 bg-black card p-3 shadow   m-3">
                                <div class="card-header text-dark d-flex justify-content-between">
                                    ...
                                    <a href="taux.php" class="btn btn-outline-danger text-white"><b><i class="bi bi-x"></i></b></a>
                                ...
                                <div class="card-footer">
                                    <a href='../models/del/del-taux.php?id=<?=$_GET['idsup'] ?>' class="btn btn-outline-danger">Supprimer</a>
                                    <a href="taux.php" class="btn btn-success">Annuler</a>
                                </div>
                                    ...
                                    <div class='shadow p-3'>
                                        <div class="row">
                                             <div class="col-xl-4 col-lg-4 col-md-4  col-sm-4 p-3">
                                                <a href='taux.php?id=<?=$last['id']?>' class="btn btn-outline-success col-12">Mettre a  jour le taux </a>
                                            </div>
                                            <div class="col-xl-8 col-lg-8 col-md-8  col-sm-8 p-3">
                                                <center><h2>Taux du jour</h2></center>
                                                <center><h2>1$ = <?=$last['equivalent']?> FC</h2></center>
                                            </div>
                                    ...
                                    <h5 class="card-title text-center "><?=$titre?></h5>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                                <label for="">taper l'equivalent en FC </span></label>
                                                <input autocomplete="off" required type="number" class="form-control" placeholder="ex: 2800"  name="equivalent" <?php if(isset($_GET['id'])){ ?> value="<?=$modData['equivalent']?>" <?php } ?>> 
                                            </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-10 col-sm-12 p-3 aling-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4  col-sm-4">
                                                <a href="taux.php" class="btn btn-dark p-2  mt-1 w-100">Annuler</a>
                                            </div>
                                        </div>
                                        <?php }else {?>
                  ...
                  <?php }  ?>
                            ...
                            <div class="shadow p-3">
                                ...
                                <h4 class="p-3 ">Historique du taux</h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">N°</th>
